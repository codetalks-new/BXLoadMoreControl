#
# Be sure to run `pod lib lint BXLoadMoreControl.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.version          = "2.0.0"
  s.summary          = "BXLoadMoreControl behaves like UIRefresh Control but is used to load more now support swift 3"
